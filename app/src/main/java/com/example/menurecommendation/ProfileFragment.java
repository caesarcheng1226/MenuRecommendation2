...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txtCunsinePContent = rootView.findViewById(R.id.txtCunsinePContent);
    ...
    private void setupText(){
        ...
        boolean isSelectWS = mPreferences.getBoolean(FirstLaunchActivity.WS_KEY,false);
        boolean isSelectCS = mPreferences.getBoolean(FirstLaunchActivity.CS_KEY,false);
        ...
        String Cusine = "Meat: " + Nom + ", Viggie: " + Nov + ", Soup: " + Nos;
        ...
        if(isSelectWS){
            DislikeMessage += "Western_Soup " ;
        }
        if(isSelectCS){
            DislikeMessage += "Chinese_Soup " ;
        }
        ...
        txtCunsinePContent.setText(Cusine);
